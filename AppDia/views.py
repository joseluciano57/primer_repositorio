...
def receptorMes(request):
    ...
    try:
        ...
        archivo = open('C:/Users/Luciano/Django_curso/proyectosdjango/ProyectoLoteria/AppDia/programas/resultados/archivo_'+ el_mes +'.csv', 'rb')
        response = FileResponse(archivo, content_type='text/csv')
...
def receptorDiaMes(request):
    ...
    try:
        archivo = open('C:/Users/Luciano/Django_curso/proyectosdjango/ProyectoLoteria/AppDia/programas/resultados/archivo_'+ dia + '_' + el_mes +'.csv', 'rb')   
...
def reportesAdicionales(request):
    ...
    try:
        if (dia==""):
            return FileResponse(open('C:/Users/Luciano/Django_curso/proyectosdjango/ProyectoLoteria/AppNumeros/programas/resultados/archivo_csv_' + tamano_secuencia +'.pdf', 'rb'), content_type='application/pdf')
        else:
            return FileResponse(open('C:/Users/Luciano/Django_curso/proyectosdjango/ProyectoLoteria/AppNumeros/programas/resultados/' + dia + '_archivo_csv_' + tamano_secuencia +'.pdf', 'rb'), content_type='application/pdf')
                                    
        #return FileResponse(open('C:/Users/Luciano/Django_curso/proyectosdjango/ProyectoLoteria/AppDia/programas/resultados/archivo_pdf.pdf', 'rb'), content_type='application/pdf')
       
        """
        archivo = open('C:/Users/Luciano/Django_curso/proyectosdjango/ProyectoLoteria/AppDia/programas/resultados/dia_'+ dia + '_' + el_mes +'.csv', 'rb')   
...
def obtienePdfHoy(request):
    ...
    try:
        return FileResponse(open('C:/Users/Luciano/Django_curso/proyectosdjango/ProyectoLoteria/AppDia/programas/resultados/posibles_jugadas.pdf', 'rb'), content_type='application/pdf')
