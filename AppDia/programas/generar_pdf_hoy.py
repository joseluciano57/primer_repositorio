...
def generar_pdf(dia,mes):
    c = canvas.Canvas("C:/Users/Luciano/Django_curso/proyectosdjango/ProyectoLoteria/AppDia/programas/resultados/posibles_jugadas.pdf", pagesize=letter)
    c.setLineWidth(.3)
    ...
    archivo="C:/Users/Luciano/Django_curso/proyectosdjango/ProyectoLoteria/AppNumeros/programas/resultados/"
    ...
    if (dia=="Sábados"):
        el_dia="sabados"    
    archivo="C:/Users/Luciano/Django_curso/proyectosdjango/ProyectoLoteria/AppDia/programas/resultados/resultados_solo_"+ el_dia +".csv"    
    ...
    archivo="C:/Users/Luciano/Django_curso/proyectosdjango/ProyectoLoteria/AppDia/programas/resultados/archivo_" + mes +".csv"    
    ...
    if (dia=="Sábados"):
        dia="Sábado"
    archivo="C:/Users/Luciano/Django_curso/proyectosdjango/ProyectoLoteria/AppDia/programas/resultados/archivo_"+ dia + "_" + mes +".csv"    
