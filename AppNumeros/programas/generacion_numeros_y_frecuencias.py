...
def calcula_frecuencias():  
    ...
    nombre_archivo="C:/Users/Luciano/Django_curso/proyectosdjango/ProyectoLoteria/AppNumeros/programas/resultados/archivo_numeros_todas_jugadas.csv"    
    ...
    nombre_archivo="C:/Users/Luciano/Django_curso/proyectosdjango/ProyectoLoteria/AppNumeros/programas/resultados/archivo_todas_jugadas_ordenados_frecuencia.csv"    
    with open(nombre_archivo, 'w',newline='',encoding="utf-8") as csvfile:
            campos = ['Número', 'Frecuencia']
            #writer = csv.DictWriter(csvfile, fieldnames=campos, delimiter=';')
