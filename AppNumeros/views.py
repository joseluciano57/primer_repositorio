...
def numerosfrecuencia(request):
    ...
    try:
        ...
        archivo = open('C:/Users/Luciano/Django_curso/proyectosdjango/ProyectoLoteria/AppNumeros/programas/resultados/archivo_todas_jugadas_ordenados_frecuencia.csv', 'rb')
